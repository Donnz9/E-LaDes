...
//        update.setEnabled(true);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_FILE_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            if (fileUri != null) {
                // You can use the file URI to upload or process the selected file
                Log.d("File Picker", "File selected: " + fileUri.toString());

                // Optionally, display the file path or URI
